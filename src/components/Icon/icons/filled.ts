...
import BookmarkAdd from '@material-design-icons/svg/filled/bookmark_add.svg';
...
import IndeterminateCheckBox from '@material-design-icons/svg/filled/indeterminate_check_box.svg';
